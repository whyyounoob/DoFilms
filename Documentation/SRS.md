...
Приложение работает только при наличии браузера и постоянного подключения к интернету(для соединения с сервером базы даныных).
...
**Описание.** Зарегистрированный пользователь имеет возмжность редактировать свою личную информацию.
